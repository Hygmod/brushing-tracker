...
const LoginForm = (props) => {
  return (
    <div>
      ...
      <div>
        <h1>Login Form</h1>
        <input type="email" placeholder="Email" id="exampleInputEmail1" name="email" onChange={(e) => props.setLoginUsername(e)} />
        <input type="password" placeholder="Password" id="password" name="password" onChange={(e) => props.setLoginPassword(e.target.value)} />
